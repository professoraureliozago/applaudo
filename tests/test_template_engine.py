...
def test_review_single_section_returns_multiple_specific_models():
    import app
    ...
    reviewed = app._apply_models_for_single_section(
        engine,
        "reto",
        "polipo sessil menor 10mm e polipo sessil maior que 10 milimetros",
        "",
    )

    assert reviewed == "Modelo menor.\nModelo maior."
